        ...
        .then(r => {
            ...
            User.findOne({"_id" : r.user }).then((data)=>{
                ...
                let message  = {
                    ...
                    <p style="font-size: 26px; line-height: 1.2; word-break: break-word; text-align: center; font-family: Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 31px; margin: 0;"><span style="font-size: 26px; color: #000000;"><strong>salut `+data.prenom+`, tu as commandé des nouveaux produits </strong></span></p></div></div></div></div></div></div></div></div>
                    <div style="background-color:transparent;">
                    <div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 520px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                    <div class="col num12" style="min-width: 320px; max-width: 520px; display: table-cell; vertical-align: top; width: 520px;">
                    ...
                    <div style="line-height: 1.2; font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; color: #555555; mso-line-height-alt: 14px;">
                    <p style="font-size: 18px; line-height: 1.2; word-break: break-word; text-align: center; font-family: Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 22px; margin: 0;"><span style="font-size: 18px;"><strong>ID de votre commande: `+r._id+`</strong></span></p></div></div>
                    <div style="color:#555555;font-family:Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;">
                    <div style="line-height: 1.2; font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; color: #555555; mso-line-height-alt: 14px;">
                    ...
                    <a href="http://192.168.1.15:9000/profile/`+data._id+`" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #000000; background-color: #e4ff69; border-radius: 23px; -webkit-border-radius: 23px; -moz-border-radius: 23px; width: auto; width: auto; border-top: 1px solid #e4ff69; border-right: 1px solid #e4ff69; border-bottom: 1px solid #e4ff69; border-left: 1px solid #e4ff69; padding-top: 3px; padding-bottom: 3px; font-family: Tahoma, Verdana, Segoe, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:35px;padding-right:35px;font-size:14px;display:inline-block;"><span style="font-size: 16px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 24px;"><span data-mce-style="font-size: 14px; line-height: 21px;" style="font-size: 14px; line-height: 21px;"><strong>Suivi tes commandes</strong></span></span></span></a></div></div></div></div></div></div></div>
...
router.get('/:userid', async (req, res) => {
    await  OrderDetail.find({'user' : req.params.userid}).populate('order.product' , 'name _id' )
    .then(data => {
        res.send(data);
    }).catch(err => {
        res.status(500).send({
...
router.put('/:Id', async (req, res) => {
    ...
    await  OrderDetail.findByIdAndUpdate(req.params.Id, {
        order: req.body.order,
...
router.delete('/:Id', async (req, res) => {
    await  OrderDetail.findByIdAndRemove(req.params.Id)
    .then(data => {
        if(!data) {
            return res.status(404).send({
                message: "Note not found with id " + req.params.Id
